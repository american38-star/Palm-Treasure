...
export default {
  ...
  data() {
    return {
      ...
      wheelSegments: [
        { value: 2, label: "0x" },      // قطاع 0 - الأعلى (12 ساعة) - خسارة
        { value: 10, label: "3x" },      // قطاع 1 - ربح كبير
        { value: 1, label: "5x" },      // قطاع 2 - ربح كبير
        { value: 1.5, label: "10x" },    // قطاع 3 - ربح كبير
        { value: 0, label: "2x" },      // قطاع 4 - ربح كبير
        { value: 3, label: "0.5x" },  // قطاع 5 - ربح صغير (نصف الرهان)
        { value: 5, label: "1x" },      // قطاع 6 - تعادل (استرجاع الرهان)
        { value: 0.5, label: "1.5x" }   // قطاع 7 - ربح كبير
      ],
